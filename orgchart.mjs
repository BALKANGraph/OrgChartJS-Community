...
}, e === void 0 && (e = {}), e.VERSION = "9.2.32", e.orientation = {}, e.orientation.top = 0, e.orientation.bottom = 1, e.orientation.right = 2, e.orientation.left = 3, e.orientation.top_left = 4, e.orientation.bottom_left = 5, e.orientation.right_top = 6, e.orientation.left_top = 7, e.anchor = {
	top_right: "top_right",
	right_top: "right_top",
...
<rect x="24" y="24" width="20" height="16" rx="2" fill="none" stroke="${n}" stroke-width="4" stroke-linejoin="round"/>
	...
	if (i && i.classList.add("boc-selected"), r != n.id) {
		var a = t.element.querySelector(`[data-ctrl-ec-id="${n.id}"]`);
		a && a.classList.add("boc-selected");
	}
	var o = t.getNode(n.pid);
	if (o) {
		let i = t.element.querySelector(`[data-l-id="[${n.parent.id}][${n.id}]"]`);
		i && i.classList.add("boc-selected"), e._addSelectedStyle(t, o, r);
	}

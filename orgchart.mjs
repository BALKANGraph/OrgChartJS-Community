...
}, e === void 0 && (e = {}), e.VERSION = "9.3.17", e.orientation = {}, e.orientation.top = 0, e.orientation.bottom = 1, e.orientation.right = 2, e.orientation.left = 3, e.orientation.top_left = 4, e.orientation.bottom_left = 5, e.orientation.right_top = 6, e.orientation.left_top = 7, e.anchor = {
	top_right: "top_right",
	right_top: "right_top",
